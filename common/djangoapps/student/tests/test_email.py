...
class ActivationEmailTests(TestCase):
    ...
    OPENEDX_FRAGMENTS = [
        ...
        "if you require assistance, check the help section of the edX website"
    ]
    ...
    EDX_DOMAIN_FRAGMENTS = [
        "Thank you for signing up for edX.",
        "http://edx.org/activate/",
        "Activating your account ensures you can sign up for and take any of the hundreds of edX courses",
